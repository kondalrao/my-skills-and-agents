...
description: Use when creating, editing, validating, or exporting draw.io diagrams
  such as architecture, flow, sequence, ER, UML, or network diagrams.
---
...
**Related skill:** Use `markdown-mermaid-writing` instead when the durable deliverable should be a Markdown document with Mermaid diagrams as the canonical source. Keep this skill for editable Draw.io artifacts.
