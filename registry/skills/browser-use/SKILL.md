---
name: browser-use
description: Use when automating browser navigation, forms, screenshots, state inspection,
  web testing, or webpage data extraction with browser-use.
---
...
- Former frontmatter `allowed-tools`: Bash(browser-use:*)
