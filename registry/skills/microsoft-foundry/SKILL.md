...
description: Use when deploying, evaluating, optimizing, or troubleshooting Microsoft
  Foundry agents, model deployments, quota, capacity, RBAC, or project setup.
---
...
- Former frontmatter `metadata`: author=Microsoft, version=1.1.5
