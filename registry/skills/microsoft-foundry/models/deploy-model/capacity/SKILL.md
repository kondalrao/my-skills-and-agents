---
name: capacity
description: Use when checking Azure OpenAI model capacity, quota, regional availability,
  or deployment feasibility before creating a model deployment.
---
...
- Former frontmatter `metadata`: author=Microsoft, version=1.0.0
