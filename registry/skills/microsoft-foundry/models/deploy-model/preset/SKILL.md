---
name: preset
description: Use when selecting a recommended Azure OpenAI model deployment preset
  based on capacity, region, quota, and project constraints.
---
...
- Former frontmatter `metadata`: author=Microsoft, version=1.0.1
