...
description: Use when teaching GitHub Copilot CLI from scratch, answering CLI questions,
  or running a beginner tutorial flow.
---
...
- Former frontmatter `allowed-tools`: ask_user, sql, fetch_copilot_cli_documentation
