# Full task-observer Workflow Archive

Archived on 2026-05-20 during user-owned skill cleanup.

The active `SKILL.md` was slimmed into a routing layer. This file preserves the previous detailed workflow content for progressive loading.
