...
description: Use when using Valyu for real-time search, URL content extraction, cited
  answers, datasource selection, or deep research.
---
...
- Former frontmatter `license`: MIT
- Former frontmatter `compatibility`: Requires network access and valid Valyu API key
- Former frontmatter `metadata`: author=valyu, version=1.0
