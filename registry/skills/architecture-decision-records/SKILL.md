...
description: Use when documenting significant architectural decisions, reviewing past
  technical choices, recording trade-offs, or establishing ADR decision processes.
---
...
- Do not treat ADR output as a substitute for environment-specific validation, testing, or expert review.
